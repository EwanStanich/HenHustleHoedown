...
@onready var greenCapturedChickens = 0
@onready var blueCapturedChickens = 0
@onready var redCapturedChickens = 0
@onready var purpleCapturedChickens = 0
var totalChickens = 0
var playerSleeping = false
var gameOver = false
var isEnteringName = false
var paused = false
var tutorial = AudioEffectSpectrumAnalyzer
var player
var chickens = []
var cows = []
var time = 0
...
func _ready():
	...
	start_ui()
	player.set_camera_limits(593,5,722,6)
	label = $GameOver/Name
...
func _on_blue_detector_body_entered(body):
	if "BlueChicken" in body.name and !isEnteringName:
...
func _on_red_detector_body_entered(body):
	if "RedChicken" in body.name and !isEnteringName:
		body.set_collision_mask_value(2, true)
		if capturedChickens < totalChickens:
...
func _on_green_detector_body_entered(body):
	var a = body.name
	if "GreenChicken" in body.name and !isEnteringName:
		body.set_collision_mask_value(2, true)
		if capturedChickens < totalChickens:
...
func _on_purple_detector_body_entered(body):
	if "PurpleChicken" in body.name and !isEnteringName:
		body.set_collision_mask_value(2, true)
		if capturedChickens < totalChickens:
...
func game_over():
	if capturedChickens == totalChickens:
		...
		player.set_camera_limits(187.5, -10, 1122, 818)
...
func update_time(name):
	...
	var url = "https://api.lootlocker.io/game/leaderboards/21222/submit"
